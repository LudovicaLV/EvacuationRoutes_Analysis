...
import org.jsstl.monitor.temporal.TemporalThreeValuesTransducer;
...
public class ForestFireAnalysisQEST2ToTryUntil {

	public static void main(String[] args) throws Exception {
		
		int runs = 3;
		String propertyName1 = "presentEM";
		String propertyName2 = "occupied";
...
//			System.out.println("trajloc0 "+Arrays.toString(val0time));
			...
			String[] varInit1 = {"O", "EM", "NN", "SS", "OS", "ON", "B", "I", "SF", "P"};
			...
			String[] varInit2 = {"O", "EM", "NN", "SS", "OS", "ON", "B", "I", "SF", "P"};
...
//		System.out.println("trajloc0 "+Arrays.toString(val0time));
		...
		String[] var = {"O", "EM", "NN", "SS", "OS", "ON", "B", "I", "SF", "P"};
...
//	SpatialThreeValues formula1 = SpatialThreeValuesTransducer.not(resultFire1);
	...
	HashMap<Integer,SpatialThreeValues> resultT = new HashMap<Integer,SpatialThreeValues>();
	double t2 = 1.0;
	double delta = 0.1;
	...
	resultT.put(i, result);}
	
	HashMap<Integer,SpatialThreeValues> TimeTSL1 = TemporalThreeValuesTransducer.until2(resultT, TimeTSLValues2, 0.0, 1.0, 0.1);	
...
//		printer.close();
	...
	PrintWriter printer = new PrintWriter("data/tryUntil.txt");
	printer.print(text);
	printer.close();
...
//	text2 += "\n";
//}
//PrintWriter printer2 = new PrintWriter("data/TSLFireBurnLastLongTry.txt");
